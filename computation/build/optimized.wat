(module
 ...
 (func $assembly/spmv/Ziggurat#constructor (result i32)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $~lib/staticarray/StaticArray<bool>#constructor (result i32)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  call $~lib/rt/tlsf/maybeInitialize
 ...
 (func $~lib/array/Array<assembly/bfs/Edge>#constructor (result i32)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $assembly/bfs/Edge#constructor (param $0 f64) (param $1 f64) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  call $~lib/rt/tlsf/maybeInitialize
 ...
 (func $~lib/array/Array<assembly/bfs/Edge>#push (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $assembly/bfs/Graph#constructor (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32) (param $5 i32) (result i32)
  (local $6 i32)
  (local $7 i32)
  (local $8 i32)
  call $~lib/rt/tlsf/maybeInitialize
 ...
 (func $assembly/bfs/initializeGraph (result i32)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $~lib/staticarray/StaticArray<assembly/fft/PolarArray>#constructor (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  local.get $0
  i32.const 268435452
 ...
 (func $assembly/fft/PolarArray#constructor (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  call $~lib/rt/tlsf/maybeInitialize
 ...
 (func $assembly/fft/randomComplexArray (result i32)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $~lib/staticarray/StaticArray<f64>#__get (param $0 i32) (result f64)
  i32.const 0
  local.get $0
  i32.const 16
  i32.sub
 ...
 (func $~lib/staticarray/StaticArray<f64>#__set (param $0 i32) (param $1 f64)
  i32.const 0
  local.get $0
  i32.const 16
  i32.sub
 ...
 (func $assembly/lud/performLud (param $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 f64)
  (local $4 i32)
 ...
 (func $assembly/pagerank/randomPages (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $assembly/pagerank/mapPageRank (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
 ...
 (func $assembly/pagerank/reducePageRank (param $0 i32) (param $1 i32) (result f64)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $assembly/spmv/Csr#constructor (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  call $~lib/rt/tlsf/maybeInitialize
 ...
 (func $~lib/util/sort/weakHeapSort<u32> (param $0 i32) (param $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
 ...
 (func $~lib/array/Array<u32>#sort (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  (local $4 i32)
 ...
 (func $assembly/spmv/generateRandomCSR (result i32)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
    ...
    loop $for-loop|3
     ...
     if
      block $assembly/spmv/genRand|inlined.0 (result i32)
       ...
       local.get $7
       select
       br_if $assembly/spmv/genRand|inlined.0
       drop
       local.get $13
       i32.const 1
       i32.add
 ...
 (func $assembly/spmv/spmvCsr (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (param $4 i32) (param $5 i32)
  (local $6 i32)
  (local $7 i32)
  (local $8 f32)
  (local $9 i32)
          ...
          block $switch$1$case$6
           block $switch$1$case$4
            block $switch$1$case$2
             ...
             i32.sub
             i32.load
             br_table $switch$1$case$2 $switch$1$case$2 $switch$1$case$4 $folding-inner0 $switch$1$case$6 $switch$1$case$7 $switch$1$case$2 $folding-inner1 $folding-inner0 $folding-inner0 $switch$1$case$2 $switch$1$case$13 $folding-inner1 $switch$1$case$15 $folding-inner1 $switch$1$case$2 $folding-inner1 $folding-inner1 $switch$1$case$20 $folding-inner0 $folding-inner0 $switch$1$case$4 $folding-inner2 $folding-inner2 $switch$1$default
            end
            return
           end
           local.get $0
